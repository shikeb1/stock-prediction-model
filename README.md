...
A full-stack AI-powered stock prediction web application using LSTM deep learning,
Django REST Framework, and React — complete with JWT authentication and interactive
chart visualizations.
Built with  by Shikeb Malik
 Table of Contents
Project Overview
Tech Stack
Project Structure
...
Contributing
 Project Overview
This portal lets authenticated users enter any stock ticker (e.g. AAPL , GOOGL , TSLA ) and
get back:
...
The ML model is a pre-trained LSTM (Long Short-Term Memory) neural network trained
on 10 years of stock data fetched from Yahoo Finance.
 Tech Stack
Layer
Technology
Frontend
React 19, Vite, Bootstrap 5, Axios, React Router v7
Backend
Django 6, Django REST Framework, SimpleJWT
ML / AI
Keras (TensorFlow), LSTM, scikit-learn, yfinance
Database
...
3. Log in
4. Enter a stock ticker like AAPL and click See Prediction
5. Charts and metrics will appear 
 Environment Variables
Variable
Description
Example
...
Add to GitHub Actions:- name: Secret Scanning with GitLeaks
...
npm audit
npm audit fix
Add to CI:- name: Python Dependency Scan
  run: |
    pip install safety
    cd backend-drf
    safety check- name: Node Dependency Audit
  run: |
    cd frontend-react
...
Add to CI after docker build:- name: Scan Docker Image with Trivy
...
MIT License.
Built with  by Shikeb Malik — From raat 2 baje to production! 
